...
print(DA.paths)
print("this is path", DA.paths.kafka_events)
...
df = spark.read.json("dbfs:/mnt/dbacademy-datasets/data-engineer-learning-path/v02/ecommerce/raw/events-kafka/000.json")
...
# MAGIC %sql
# MAGIC df.createOrReplaceTempView("events_json")
# MAGIC display(df)
